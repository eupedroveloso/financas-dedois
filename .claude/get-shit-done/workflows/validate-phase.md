...
```
Agent(
  prompt="Read /Users/veloso/Documents/GitHub/dedois-v1/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/veloso/Documents/GitHub/dedois-v1/.claude/get-shit-done/templates/VALIDATION.md`
