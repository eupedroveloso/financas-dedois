...
```bash
INIT=$(node "/Users/veloso/Documents/GitHub/dedois-v1/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/Users/veloso/Documents/GitHub/dedois-v1/.claude/get-shit-done/templates/spec.md.
